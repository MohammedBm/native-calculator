...
class Calculator extends React.Component {
  ...
  render() {
    ...
    return ( <
      ...
      /> <
      View style = {
        calculatorStyles.keypad
      } >
      <
      View style = {
        calculatorStyles.inputKeys
      } >
      <
      View style = {
        calculatorStyles.functionKeys
      } >
      <
      FunctionKey onPress = {
      ...
      style = {
        calculatorStyles.keySign
      } > ± < /FunctionKey> <
      FunctionKey onPress = {
        () => this.inputPercent()
      }
      style = {
        calculatorStyles.keyPercent
      } > % < /FunctionKey> <
      /View> <
      View style = {
        calculatorStyles.digitKeys
      } >
      <
      DigitKey onPress = {
        () => this.inputDigit(0)
      ...
      style = {
        calculatorStyles.keyDot
      }
      textStyle = {
        calculatorStyles.keyDotText
      } > . < /DigitKey> <
      DigitKey onPress = {
        () => this.inputDigit(1)
      } > 1 < /DigitKey> <
...
const DigitKey = (props) => ( <
  ...
  style = {
    [calculatorStyles.digitKey, props.style]
  }
  textStyle = {
    [calculatorStyles.digitKeyText, props.textStyle]
  }
  />
)
...
const FunctionKey = (props) => ( <
  ...
  style = {
    [calculatorStyles.functionKey, props.style]
  }
  textStyle = {
    [calculatorStyles.functionKeyText, props.textStyle]
  }
  />
)
...
const OperatorKey = (props) => ( <
  ...
  style = {
    [calculatorStyles.operatorKey, props.style]
  }
  textStyle = {
    [calculatorStyles.operatorKeyText, props.textStyle]
  }
  />
)
